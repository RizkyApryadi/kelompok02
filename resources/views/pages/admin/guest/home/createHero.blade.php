...
<div class="container mx-auto py-12 px-6">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-3xl mx-auto">
        <h2 class="text-3xl font-extrabold text-gray-800 text-center mb-6">Sambutan Kepala Sekolah</h2>
        ...
        <form action="{{ route('home.storeHero') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <textarea name="message" id="message" rows="4"
                    class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Tulis sambutan di sini..."></textarea>
            </div>
